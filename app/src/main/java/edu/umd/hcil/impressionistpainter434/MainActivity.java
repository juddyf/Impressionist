...
public class MainActivity extends AppCompatActivity implements OnMenuItemClickListener  {
    ...
    private SensorEventListener sensorEvent = new SensorEventListener() {
        ...
        public void onSensorChanged(SensorEvent event) {
            Random r = new Random();
            ImpressionistView _impressionistView = (ImpressionistView)findViewById(R.id.viewImpressionist);

            if (_impressionistView.getBrushType() == BrushType.StepSplatter) {
                _impressionistView.drawStep();
            }
        }
    };
    ...
    public boolean onMenuItemClick(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.menuCircleSplatter:
                ...
                return true;
            case R.id.menuStepSplatter:
                Toast.makeText(this, "Step Splatter Brush", Toast.LENGTH_SHORT).show();
                _impressionistView.setBrushType(BrushType.StepSplatter);
                return true;
        }
        return false;
    }
    ...
    /**
     * Saves the drawn image to the galler.
     *
     * @param v
     */
    public void onButtonClickSave(View v) { //REFERENCE: http://stackoverflow.com/questions/20859584/how-to-save-image-in-android-gallery
        AlertDialog.Builder save = new AlertDialog.Builder(this);
        save.setMessage("Save drawing to device Gallery?");
        ...
        save.setPositiveButton("Yes", new DialogInterface.OnClickListener(){
            public void onClick(DialogInterface dialog, int which){
                ...
                try {
                    ...
                    MediaStore.Images.Media.insertImage(getContentResolver(), bitmap, fName, "Impressionist painting");
